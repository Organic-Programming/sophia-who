...
func TestWriteHolonMDRoundTrip(t *testing.T) {
	...
	if parsed.WrappedLicense != original.WrappedLicense {
		t.Errorf("WrappedLicense: got %q, want %q", parsed.WrappedLicense, original.WrappedLicense)
	}
